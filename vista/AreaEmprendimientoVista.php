            ...
            <div class="card m-2 border border-secondary">
                <div class="card-header pb-1 px-1">
                    <div class="container-fluid d-flex justify-content-between flex-wrap">
                        ...
                        <a href="?pagina=<?php configSistema::_M10_();?>" class="px-1" style="font-size:18px;">Area de Emprendimiento</a>
                        </div>
                    </div><!-- /.container-fluid -->
                </div>
                <!-- Main content -->
...
if (isset($response[0]["registrar"])) {
    if ($response[0]["registrar"] == 'true') {?>
                                <button class="btn p-1 my-1 text-white" style="background:#0C72C4" id="nuevo"><i class="fas fa-plus-square mx-1"></i>Registrar</button>
                                <?php }}?>
                            </div>
                            <!-- /.card-header -->
                            <?php

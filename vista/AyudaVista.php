                    ...
                    <h4 class="card-title fw-bold">1.Iniciar Sistema <br></h4>
                            ...
                            <div id="carouselExample" class="carousel slide">
                                <div class="carousel-inner">
                                    ...
                                    <img src="assets/img/login.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/Loginrecuperar.png"  class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/recuperacion.png"  class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/correoenviado.png"  class="d-block w-100">
                                    </div>
                                </div>
            ...
            <div class="card-body">
                <div class="card-block">
                    <h4 class="card-title m-t-40 fw-bold">3. Inicio <br></h4>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                    <img src="assets/img/inicio.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/inicio1.png"  class="d-block w-100">
                                    </div>
                                </div>
                ...
                <div class="card-block">
                    ...
                    <h4 class="card-title m-t-40" id="4">Registrar<br></h4>
                                ...
                                <div class="text-center">
                                     <img class="rounded" src="assets/img/registrar.png">
                                </img>
                                </div>
                    ...
                    <h4 class="card-title m-t-40" id="4">Eliminar  <br></h4>
                                <p><br>
                                  ...
                                  operacion, caso contrario al estar seguro de eliminar el registro, pulsar el boton de confirmar para realizar dicha operación.
                                </p>
            ...
            <div class="card-body">
                <div class="card-block">
                    <h4 class="card-title m-t-40 fw-bold" id="4">6. Mensajes de alerta <br></h4>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                    <img src="assets/img/Exitoso.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/Info.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/Info1.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/Eliminar.png" class="d-block w-100">
                                    </div>
                                </div>
                                <button class="carousel-control-prev" type="button" data-target="#carouselExample4" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Anterior</span>
                                </button>
                                <button class="carousel-control-next" type="button" data-target="#carouselExample4" data-slide="next">
                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Siguiente</span>
                                </button>
                            </div>
            ...
            <div class="card-body">
                <div class="card-block">
                    <h4 class="card-title m-t-40 fw-bold" id="4">7. Gestionar Registro<br></h4>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                    <img src="assets/img/registrossistema.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/registros.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/Aspirantes.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/Evaluaciones.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/Estudiantes.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/Docentes.png" class="d-block w-100">
                                    </div>
                                </div>
                                <button class="carousel-control-prev" type="button" data-target="#carouselExample10" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Anterior</span>
                                </button>
                                <button class="carousel-control-next" type="button" data-target="#carouselExample10" data-slide="next">
                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Siguiente</span>
                                </button>
                            </div>
                ...
                <div class="card-block">
                    <h4 class="card-title m-t-40 fw-bold" id="4">8. Opciones de Unidad<br></h4>
                            ...
                            <div id="carouselExample1" class="carousel slide">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                    <img src="assets/img/Aula.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/CrearUnidad.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/verUnidad.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/OpcionesUnidad.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/EditarUnidad.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/EliminarUnidad.png" class="d-block w-100">
                                    </div>
                                </div>
                                <button class="carousel-control-prev" type="button" data-target="#carouselExample1" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Anterior</span>
                                </button>
                                <button class="carousel-control-next" type="button" data-target="#carouselExample1" data-slide="next">
                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Siguiente</span>
                                </button>
                            </div>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                    <img src="assets/img/Publicarforo.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/foropublic.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/publicaciones.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/participantes.png" class="d-block w-100">
                                    </div>
                                </div>
            ...
            <div class="card-body">
                <div class="card-block">
                    <h4 class="card-title m-t-40 fw-bold" id="4">9. Gestionar Seguridad<br></h4>
                                ...
                                <div class="text-center">
                                     <img class="rounded" src="assets/img/permisos.png">
                                </img>
                                </div>
                            ...
                            <div id="carouselExample5" class="carousel slide">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                    <img src="assets/img/Permisosyroles.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/ventanapermisos.png" class="d-block w-100">
                                    </div>
                                </div>
                                <button class="carousel-control-prev" type="button" data-target="#carouselExample5" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Anterior</span>
                                </button>
                                <button class="carousel-control-next" type="button" data-target="#carouselExample5" data-slide="next">
                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Siguiente</span>
                                </button>
                            </div>
<br>
                            ...
                            <div id="carouselExample6" class="carousel slide">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                    <img src="assets/img/asignarrol.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/ventanarol.png" class="d-block w-100">
                                    </div>
                                </div>
                                <button class="carousel-control-prev" type="button" data-target="#carouselExample6" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Anterior</span>
                                </button>
                                <button class="carousel-control-next" type="button" data-target="#carouselExample6" data-slide="next">
                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Siguiente</span>
                                </button>
                            </div>
                            ...
                            <div id="carouselExample6" class="carousel slide">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                    <img src="assets/img/modulobitacora.png" class="d-block w-100">
                                    </div>
                                </div>
                                <button class="carousel-control-prev" type="button" data-target="#carouselExample6" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            ...
            <div class="card-body">
                <div class="card-block">
                    <h4 class="card-title m-t-40 fw-bold" id="4">10. Salir del sistema  <br></h4>
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                    <img src="assets/img/usuariosalir.png" class="d-block w-100">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/img/salirsistema.png" class="d-block w-100">
                                    </div>
                                </div>
                                <button class="carousel-control-prev" type="button" data-target="#carouselExample7" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Anterior</span>
                                </button>
                                <button class="carousel-control-next" type="button" data-target="#carouselExample7" data-slide="next">
                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Siguiente</span>
                                </button>
                            </div>

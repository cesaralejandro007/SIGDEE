                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <?php }}?>
                                                    <blockquote style="border-radius: 4px 0px 0px 0px;">
                                                        ...
                                                        <a target="_blank" href="<?php echo "http://localhost/dashboard/www/SIGDEE/content/contenidos/". $contenido['archivo']?>">Documento Ajunto <i
                                            ...
                                            <div class="card-body p-0">
                                                <?php foreach ($listar_evaluaciones as $evaluacion) {?>
                                                    ...
                                                    <div class="card card-light border">
                                                        ...
                                                        <a target="_blank" href="<?php echo "http://localhost/dashboard/www/SIGDEE/content/evaluaciones/". $evaluacion['archivo']?>">Documento Ajunto <i
                                                                class="fas fa-cloud-download-alt"></i></a>
                                                    </blockquote>

...
<body class="hold-transition sidebar-mini">
            ...
            <div class="card m-2 border border-dark">
                <div class="card-header">
                    <div class="container-fluid d-flex justify-content-start">
                        <div>
                            <h5>Reportes de estudiantes aprobados y reprobados</h5>
                        </div>
                        <div class="px-5">
                    ...
                    <div class="row">
                        <div class="form-group row selectores" id="selectores">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Unidad</label>
                                    <select class="form-control select2bs4" id="unidad" name="unidad"
                                    style="width: 100%;">
                                        <option disabled selected value="0">Seleccione</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" id="evaluacion" name="evaluacion"
                                    style="width: 100%;">
                                        <option disabled selected value="0">Seleccione</option>
                                    </select>
                                    <span id="sevaluacion"></span>
                                </div>
                            </div>
                        </div>
                        <div>
    ...
    <script src="content/js/reportes.js"></script>

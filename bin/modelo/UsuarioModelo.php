...
class UsuarioModelo extends connectDB
{
    ...
    public function incluir($cedula,$nombre,$apellido,$correo,$direccion,$telefono,$clave)
    {
        $validar_registro = $this->validar_registro($cedula);
        $validar_expresion = $this->validar_expresiones($cedula,$nombre,$apellido,$correo,$direccion,$telefono,$clave);
        if ($validar_registro==false) {
            ...
            try {
                $this->conex->query("INSERT INTO usuario(cedula, nombre,  apellido, correo, direccion, telefono, clave)
					VALUES('$cedula', '$nombre', '$apellido', '$correo', '$direccion','$telefono', '$clave')");
    ...
    public function modificar($id,$cedula,$nombre,$apellido,$correo,$direccion,$telefono)
    {

...
$(document).ready(function() {    
  var table = $('#funcionpaginacion').DataTable({      
      ...
      buttons:[ 
    {
      extend:    'excelHtml5',
      filename: function() {
        return "EXCEL-Contenidos"      
      },          
      title: function() {
        var searchString = table.search();        
        return searchString.length? "Search: " + searchString : "Reporte de Contenidos"
      },
...
function carga() {
  ...
  document.getElementById("nuevo").onclick = function () {
    ...
    $("#titulo").text("Registrar nuevo contenido");
    $("#enviar").text("Registrar");
    $("#gestion-contenido").modal("show");
  };
}

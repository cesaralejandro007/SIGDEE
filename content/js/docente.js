...
function carga() {
  ...
  document.getElementById("nuevo").onclick = function () {
    ...
    $("#titulo").text("Registrar nuevo docente");
    $("#enviar").text("Registrar");
    $("#gestion-docente").modal("show");
  };
}
